"""ResNet backbones adapted for VI-ReID feature extraction."""
...
class Bottleneck(nn.Module):
    """Bottleneck block used by the ResNet-50/101/152 variants."""
    expansion = 4
...
class ResNet(nn.Module):
    """ResNet variant exposing stride/dilation control for the final stage."""
    def __init__(self, block, layers, last_conv_stride=2, last_conv_dilation=1):
        # last_conv_stride/dilation keep higher spatial resolution for part/prototype pooling.
        self.inplanes = 64
...
def remove_fc(state_dict):
    """Drop ImageNet classifier weights before loading pretrained features."""
...
def resnet50(pretrained=False, **kwargs):
    """Construct the default ResNet-50 backbone used by the project."""
