"""Custom Ignite metrics for scalar losses and key-value training logs."""
...
class ScalarMetric(Metric):
    """Average scalar values emitted by the trainer."""
...
class IgnoreAccuracy(Accuracy):
    """Accuracy variant that excludes labels equal to ignore_index."""
...
class AutoKVMetric(Metric):
    """Aggregate arbitrary metric dictionaries returned by the model."""
    def __init__(self):
