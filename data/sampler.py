"""Samplers that form modality-balanced or identity-balanced mini-batches."""
...
class CrossModalityRandomSampler(Sampler):
    """Interleave visible and infrared samples to avoid modality-skewed batches."""
...
class CrossModalityIdentitySampler(Sampler):
    """Sample P identities with K/2 visible and K/2 infrared images per identity."""
...
class RandomIdentitySampler(Sampler):
    """Sample K images per identity regardless of modality for ID-balanced training."""
...
class NormTripletSampler(Sampler):
    """Build triplet-friendly batches by grouping several images of each identity."""
    def __init__(self, data_source, batch_size, num_instances):
        self.data_source = data_source
        self.batch_size = batch_size
        self.num_instances = num_instances
