"""Small tensor-level augmentations used after image-to-tensor conversion."""
...
class RandomGrayscale:
    """Randomly copy one channel into the others to weaken color dependence."""
...
class I2V:
    """Approximate infrared-to-visible channel expansion for modality robustness."""
    def __init__(self) -> None:
        pass
...
class RandomResize:
    """Resize with random height perturbation while keeping the final crop width fixed."""
    def __init__(self):
...
class RandomImageErasing:
    """Copy a random patch over another region instead of filling with a constant."""
